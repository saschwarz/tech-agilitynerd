...
I added the pub_date field to the index to allow the matching search
...
The use_template keyword requires you to create a Django template file
...
only the result_text attribute should be accessed:
